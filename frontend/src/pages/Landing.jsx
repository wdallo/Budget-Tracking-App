  ...
  const features = [
    {
      ...
      description:
        "Monitor your income and expenses with detailed transaction tracking and real-time updates.",
    },
    {
      icon: PieChart,
      title: "Visual Analytics",
      description:
        "Get insights with beautiful charts and graphs that help you understand your spending patterns.",
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      title: "Easy to Use",
      description:
        "Intuitive interface designed for everyone, from beginners to financial experts.",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        "This app has completely transformed how I manage my business finances. The analytics are incredibly helpful!",
      rating: 5,
    },
    {
      name: "Mike Chen",
      role: "Freelancer",
      content:
        "Finally, a finance app that's both powerful and easy to use. The budget tracking feature is a game-changer.",
      rating: 5,
    },
    {
      name: "Emily Davis",
      role: "Student",
      content:
        "Perfect for tracking my expenses as a student. The visual charts help me understand where my money goes.",
      rating: 5,
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              ...
              spending habits with our comprehensive finance management
              platform.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              ...
              finances better than ever before.
            </p>
          </div>
